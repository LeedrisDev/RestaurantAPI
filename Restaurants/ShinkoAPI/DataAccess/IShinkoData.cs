...
/// <summary>
/// Data Access Layer for the Shinko API
/// </summary>
public interface IShinkoData
{
    /// <summary>
    ...
    public Task<IList<DateTime>> GetAvailableReservationsSummary(DateTime beginDate, DateTime endDate, int nbGuests, bool isLunch, bool isDinner);

    
    /// <summary>
    /// Return a list of all available reservations with day and hour
    /// </summary>
    /// <param name="beginDate">Datetime object.</param>
    /// <param name="endDate">Datetime object.</param>
    /// <param name="nbGuests">Number of guests wanted for the reservations.</param>
    ...
    /// <returns>A list of all available reservations</returns>
    /// <returns>A list of all available reservations</returns>
    public Task<IList<DateTime>> GetAvailableReservations(DateTime beginDate, DateTime endDate, int nbGuests,
